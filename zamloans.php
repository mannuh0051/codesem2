...
<style>
  :root {
    ...
    --muted:   #6b7490;
    --radius:  10px;
    --shadow:  0 2px 14px rgba(10,31,68,0.08);
  }
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .navbar .brand-name span { color: var(--gold2); }
  .navbar .tagline { color: rgba(255,255,255,0.45); font-size: 0.75rem; }

  /* ── HERO ── */
  .hero-bar {
    background: linear-gradient(160deg, var(--navy) 0%, var(--navy2) 60%, #1a3a7a 100%);
  ...
  .hero-bar h1 span { color: var(--gold2); }
  ...
  .loan-count-badge { background: var(--navy); color: var(--gold2); font-size: 0.72rem; font-weight: 700; padding: 4px 12px; border-radius: 20px; }
